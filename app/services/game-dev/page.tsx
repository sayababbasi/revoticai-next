...
export const metadata = {
  ...
  description: 'Create immersive, high-performance video games for PC, console, and mobile platforms.',
};

const GameDevServicesPage: React.FC = () => {
  return (
      ...
      <section className="relative pt-[150px] pb-24 md:pt-[200px] md:pb-32 overflow-hidden border-b border-white/5">
        ...
        <div className="container mx-auto px-6 relative z-10 max-w-7xl">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 mb-8 backdrop-blur-md">
            ...
            <span className="text-sm font-medium tracking-wide text-gray-300 uppercase">Immersive Worlds</span>
          </div>
          
          <h1 className="text-6xl md:text-8xl font-black mb-8 tracking-tighter leading-[1.1]">
            Game <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#b1ff32] to-[#7acc00]">Development</span>
          </h1>
          
          <p className="text-xl md:text-2xl text-gray-400 max-w-3xl leading-relaxed mb-12 font-light">
            From hyper-casual mobile hits to breathtaking AAA console experiences. We bring imaginations to life with cutting-edge engines, stunning art, and flawless mechanics.
          </p>
      ...
      <section id="services" className="py-24 md:py-32 relative">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="mb-16 md:mb-24">
            ...
            <p className="text-xl text-gray-400 max-w-2xl">Full-cycle game development across all major platforms.</p>
          </div>
            ...
            {[
              {
                ...
                desc: "We build on industry-leading engines, creating robust, visually stunning games that leverage the full power of modern hardware."
              },
              {
                icon: MonitorPlay,
                title: "PC & Console Games",
                desc: "Deliver high-fidelity, expansive gaming experiences tailored for Windows, PlayStation, and Xbox ecosystems."
              },
              {
                icon: Gamepad2,
                title: "Mobile Game Dev",
                desc: "From 2D puzzles to 3D RPGs, we craft optimized, highly addictive mobile games for iOS and Android devices."
              },
              {
                icon: Sparkles,
                title: "AR / VR Experiences",
                desc: "Push the boundaries of reality. We develop immersive Virtual and Augmented Reality games that completely captivate players."
              }
            ].map((service, idx) => (
      ...
      <section className="py-24 md:py-32 bg-white/[0.02] border-y border-white/5 relative">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-gray-400 max-w-2xl mx-auto">Our pipeline from conceptual art to gold master.</p>
          </div>
          ...
          <div className="grid md:grid-cols-4 gap-8 relative">
            ...
            {[
              { step: "01", title: "Pre-Production", desc: "Game Design Document (GDD), concept art, and core loop prototyping.", icon: PenTool },
              { step: "02", title: "Production", desc: "Asset creation, level design, and intensive gameplay programming.", icon: Code2 },
              { step: "03", title: "Testing & QA", desc: "Rigorous bug hunting, balance tweaks, and performance profiling.", icon: TestTube2 },
              { step: "04", title: "Release & LiveOps", desc: "Publishing to stores, managing updates, and scaling server infrastructure.", icon: Rocket }
            ].map((item, idx) => (
        ...
        <div className="container mx-auto px-6 max-w-7xl flex flex-col md:flex-row gap-16 items-center">
          <div className="md:w-1/2">
            ...
            <p className="text-xl text-gray-400 mb-10 leading-relaxed">
              We are passionate gamers and hardcore engineers. We don't just write code; we obsess over "game feel," performance frames, and player retention.
            </p>
            <ul className="space-y-6">
              {[
                "Expertise in multiplayer netcode and matchmaking.",
                "Stunning 2D/3D art, animation, and VFX pipelines.",
                "Highly optimized for 60/120fps targets.",
                "Post-launch LiveOps and monetization strategies."
              ].map((text, idx) => (
          ...
          <div className="md:w-1/2 grid grid-cols-2 gap-6 w-full">
            <div className="bg-white/[0.03] border border-white/10 p-8 rounded-3xl text-center flex flex-col justify-center transform translate-y-8">
              <span className="text-5xl font-black text-white mb-2">AAA</span>
              <span className="text-gray-400 font-medium">Quality Standards</span>
            </div>
            <div className="bg-[#b1ff32]/10 border border-[#b1ff32]/20 p-8 rounded-3xl text-center flex flex-col justify-center">
              <span className="text-5xl font-black text-[#b1ff32] mb-2">120</span>
              <span className="text-gray-300 font-medium">FPS Optimization</span>
            </div>
            <div className="bg-white/[0.03] border border-white/10 p-8 rounded-3xl text-center flex flex-col justify-center">
              <span className="text-5xl font-black text-white mb-2">Multi</span>
              <span className="text-gray-400 font-medium">Platform Experts</span>
            </div>
            <div className="bg-white/[0.03] border border-white/10 p-8 rounded-3xl text-center flex flex-col justify-center transform -translate-y-8 mt-16 md:mt-0">
              <span className="text-5xl font-black text-white mb-2">3D</span>
              <span className="text-gray-400 font-medium">Immersive Worlds</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 relative px-6">
        <div className="max-w-6xl mx-auto bg-[#b1ff32] rounded-[3rem] p-12 md:p-20 text-center relative overflow-hidden">
          ...
          <p className="mb-12 text-black/80 text-xl font-medium max-w-2xl mx-auto relative z-10 leading-relaxed">
            Turn your concept into reality. Reach out to our production team to discuss timelines, engines, and scope.
          </p>
          <a
            href="/contact"
...
export default GameDevServicesPage;
