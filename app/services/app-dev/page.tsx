      ...
      <section className="relative pt-[150px] pb-24 md:pt-[200px] md:pb-32 overflow-hidden border-b border-white/5">
        ...
        <div className="container mx-auto px-6 relative z-10 max-w-7xl">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 mb-8 backdrop-blur-md">
            ...
            <span className="text-sm font-medium tracking-wide text-gray-300 uppercase">Seamless Experiences</span>
          </div>
          
          <h1 className="text-6xl md:text-8xl font-black mb-8 tracking-tighter leading-[1.1]">
            Mobile App <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#b1ff32] to-[#7acc00]">Development</span>
          </h1>
          
          <p className="text-xl md:text-2xl text-gray-400 max-w-3xl leading-relaxed mb-12 font-light">
            We create powerful, intelligent, and user-centric mobile applications that connect your business with users on the go. Elevate your brand with world-class native and cross-platform apps.
          </p>
      ...
      <section id="services" className="py-24 md:py-32 relative">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="mb-16 md:mb-24">
            ...
            <p className="text-xl text-gray-400 max-w-2xl">Crafting high-performance mobile experiences for global audiences.</p>
          </div>
            ...
            {[
              {
                ...
                desc: "We leverage modern frameworks like React Native and Flutter to build high-performance applications that work seamlessly on both iOS and Android."
              },
              {
                icon: Smartphone,
                title: "Native iOS & Android",
                desc: "For complex use-cases requiring deep hardware integration, we build optimized native applications using Swift, Kotlin, and Java."
              },
              {
                icon: Cpu,
                title: "AI-Powered Features",
                desc: "Enhance your mobile app with edge AI, personalization engines, voice assistants, and computer vision capabilities to stand out."
              },
              {
                icon: PenTool,
                title: "UI/UX App Design",
                desc: "We craft intuitive and stunning mobile interfaces designed specifically for mobile interactions, ensuring high engagement and retention."
              }
            ].map((service, idx) => (
      ...
      <section className="py-24 md:py-32 bg-white/[0.02] border-y border-white/5 relative">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-gray-400 max-w-2xl mx-auto">From concept to App Store, our streamlined delivery model.</p>
          </div>
          ...
          <div className="grid md:grid-cols-4 gap-8 relative">
            ...
            {[
              { step: "01", title: "Discovery", desc: "Understanding your audience, market trends, and defining core features.", icon: Search },
              { step: "02", title: "Prototyping", desc: "Designing wireframes, user journeys, and high-fidelity UI mockups.", icon: Figma },
              { step: "03", title: "Development", desc: "Agile coding sprints with continuous testing across real devices.", icon: Code2 },
              { step: "04", title: "Launch", desc: "App Store optimization, submission, and post-launch maintenance.", icon: Rocket }
            ].map((item, idx) => (
        ...
        <div className="container mx-auto px-6 max-w-7xl flex flex-col md:flex-row gap-16 items-center">
          <div className="md:w-1/2">
            ...
            <p className="text-xl text-gray-400 mb-10 leading-relaxed">
              We build mobile applications that users love and businesses rely on. Performance, aesthetics, and scalability are at the core of what we do.
            </p>
            <ul className="space-y-6">
              {[
                "Optimized for 60fps native performance.",
                "Pixel-perfect, human-centric UI/UX design.",
                "Rigorous automated and manual QA testing.",
                "Seamless backend integration and API connectivity."
              ].map((text, idx) => (
          ...
          <div className="md:w-1/2 grid grid-cols-2 gap-6 w-full">
            <div className="bg-white/[0.03] border border-white/10 p-8 rounded-3xl text-center flex flex-col justify-center transform translate-y-8">
              <span className="text-5xl font-black text-white mb-2">99%</span>
              <span className="text-gray-400 font-medium">Crash-free Rate</span>
            </div>
            <div className="bg-[#b1ff32]/10 border border-[#b1ff32]/20 p-8 rounded-3xl text-center flex flex-col justify-center">
              <span className="text-5xl font-black text-[#b1ff32] mb-2">5★</span>
              <span className="text-gray-300 font-medium">User Ratings</span>
            </div>
            <div className="bg-white/[0.03] border border-white/10 p-8 rounded-3xl text-center flex flex-col justify-center">
              <span className="text-5xl font-black text-white mb-2">iOS</span>
              <span className="text-gray-400 font-medium">& Android Experts</span>
            </div>
            <div className="bg-white/[0.03] border border-white/10 p-8 rounded-3xl text-center flex flex-col justify-center transform -translate-y-8 mt-16 md:mt-0">
              ...
              <span className="text-gray-400 font-medium">Faster Delivery</span>
            </div>
          </div>
        </div>
      </section>
