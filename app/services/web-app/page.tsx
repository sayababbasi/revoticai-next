...
export const metadata = {
  title: 'Web App Development Services - Revotic AI',
  description: 'Custom, high-performance web applications built with modern frontend and backend technologies.',
};

const WebAppServicesPage: React.FC = () => {
  return (
      ...
      <section className="relative pt-[150px] pb-24 md:pt-[200px] md:pb-32 overflow-hidden border-b border-white/5">
        ...
        <div className="container mx-auto px-6 relative z-10 max-w-7xl">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 mb-8 backdrop-blur-md">
            ...
            <span className="text-sm font-medium tracking-wide text-gray-300 uppercase">Enterprise Web Apps</span>
          </div>
          
          <h1 className="text-6xl md:text-8xl font-black mb-8 tracking-tighter leading-[1.1]">
            Web App <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#b1ff32] to-[#7acc00]">Development</span>
          </h1>
          
          <p className="text-xl md:text-2xl text-gray-400 max-w-3xl leading-relaxed mb-12 font-light">
            We engineer lightning-fast, secure, and scalable web applications. Utilizing modern stacks, we deliver progressive web apps (PWAs) and enterprise portals that perform seamlessly on any device.
          </p>
      ...
      <section id="services" className="py-24 md:py-32 relative">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="mb-16 md:mb-24">
            ...
            <p className="text-xl text-gray-400 max-w-2xl">Modern engineering for complex web solutions.</p>
          </div>
            ...
            {[
              {
                ...
                desc: "We build highly responsive, interactive interfaces using React, Next.js, and Vue.js, ensuring blazing-fast load times and optimal SEO."
              },
              {
                icon: Server,
                title: "Backend Development",
                desc: "Robust, secure, and scalable backend architectures using Node.js, Python, or Go to power complex business logic and data processing."
              },
              {
                icon: Globe,
                title: "Progressive Web Apps",
                desc: "Combine the best of web and mobile. We build PWAs that offer offline capabilities, push notifications, and app-like experiences."
              },
              {
                icon: Code2,
                title: "Custom Portals & CRMs",
                desc: "Tailor-made internal tools, B2B portals, and customer relationship management systems designed to streamline your specific operations."
              }
            ].map((service, idx) => (
      ...
      <section className="py-24 md:py-32 bg-white/[0.02] border-y border-white/5 relative">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-gray-400 max-w-2xl mx-auto">An agile, iterative approach to web development.</p>
          </div>
          ...
          <div className="grid md:grid-cols-4 gap-8 relative">
            ...
            {[
              { step: "01", title: "Discovery", desc: "Understanding your technical requirements and defining the software stack.", icon: Search },
              { step: "02", title: "Prototyping", desc: "Creating interactive wireframes and mapping database schemas.", icon: PenTool },
              { step: "03", title: "Development", desc: "Agile sprints combining frontend interfaces and backend APIs.", icon: Terminal },
              { step: "04", title: "Deployment", desc: "Setting up CI/CD pipelines, cloud hosting, and continuous monitoring.", icon: Rocket }
            ].map((item, idx) => (
        ...
        <div className="container mx-auto px-6 max-w-7xl flex flex-col md:flex-row gap-16 items-center">
          <div className="md:w-1/2">
            ...
            <p className="text-xl text-gray-400 mb-10 leading-relaxed">
              We build the web of the future. Our applications are engineered to be resilient, lightning-fast, and secure against modern threats.
            </p>
            <ul className="space-y-6">
              {[
                "Modern Jamstack and Serverless architectures.",
                "Optimized for Core Web Vitals and SEO.",
                "Rigorous automated testing and code reviews.",
                "High-availability cloud deployments on AWS/GCP."
              ].map((text, idx) => (
          ...
          <div className="md:w-1/2 grid grid-cols-2 gap-6 w-full">
            <div className="bg-white/[0.03] border border-white/10 p-8 rounded-3xl text-center flex flex-col justify-center transform translate-y-8">
              <span className="text-5xl font-black text-white mb-2">100/100</span>
              <span className="text-gray-400 font-medium">Lighthouse Score</span>
            </div>
            <div className="bg-[#b1ff32]/10 border border-[#b1ff32]/20 p-8 rounded-3xl text-center flex flex-col justify-center">
              <span className="text-5xl font-black text-[#b1ff32] mb-2">Global</span>
              <span className="text-gray-300 font-medium">CDN Delivery</span>
            </div>
            <div className="bg-white/[0.03] border border-white/10 p-8 rounded-3xl text-center flex flex-col justify-center">
              ...
              <span className="text-gray-400 font-medium">OWASP Compliance</span>
            </div>
            <div className="bg-white/[0.03] border border-white/10 p-8 rounded-3xl text-center flex flex-col justify-center transform -translate-y-8 mt-16 md:mt-0">
              <span className="text-5xl font-black text-white mb-2">Custom</span>
              <span className="text-gray-400 font-medium">API Integrations</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 relative px-6">
        <div className="max-w-6xl mx-auto bg-[#b1ff32] rounded-[3rem] p-12 md:p-20 text-center relative overflow-hidden">
          ...
          <p className="mb-12 text-black/80 text-xl font-medium max-w-2xl mx-auto relative z-10 leading-relaxed">
            Let's create a robust, scalable web application tailored to your business needs. Connect with our development team today.
          </p>
          <a
            href="/contact"
...
export default WebAppServicesPage;
