...
export const metadata = {
  title: 'Data & Analytics Services - Revotic AI',
  description: 'Unlock the true value of your data with advanced analytics, big data processing, and business intelligence.',
};
      ...
      <section className="relative pt-[150px] pb-24 md:pt-[200px] md:pb-32 overflow-hidden border-b border-white/5">
        ...
        <div className="container mx-auto px-6 relative z-10 max-w-7xl">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 mb-8 backdrop-blur-md">
            ...
            <span className="text-sm font-medium tracking-wide text-gray-300 uppercase">Actionable Insights</span>
          </div>
          
          <h1 className="text-6xl md:text-8xl font-black mb-8 tracking-tighter leading-[1.1]">
            Data & <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#b1ff32] to-[#7acc00]">Analytics</span>
          </h1>
          
          <p className="text-xl md:text-2xl text-gray-400 max-w-3xl leading-relaxed mb-12 font-light">
            Transform fragmented data into your most valuable asset. We build robust data pipelines, scalable warehouses, and intuitive dashboards that drive confident decision-making.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-6">
            <a href="#services" className="inline-flex justify-center items-center gap-2 bg-[#b1ff32] text-black px-8 py-4 rounded-full text-lg font-bold hover:bg-white transition-all hover:scale-105 active:scale-95 shadow-[0_0_40px_rgba(177,255,50,0.3)]">
              Explore Data Solutions <ArrowRight size={20} />
            </a>
      ...
      <section id="services" className="py-24 md:py-32 relative">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="mb-16 md:mb-24">
            ...
            <p className="text-xl text-gray-400 max-w-2xl">End-to-end data engineering and analytics architectures.</p>
          </div>
            ...
            {[
              {
                ...
                desc: "We design and build resilient ETL/ELT pipelines to extract, clean, and load data from disparate sources into centralized lakes or warehouses."
              },
              {
                icon: BarChart4,
                title: "Business Intelligence",
                desc: "Unlock real-time visibility. We create interactive, dynamic dashboards using tools like Tableau, PowerBI, and custom React interfaces."
              },
              {
                icon: Database,
                title: "Big Data Processing",
                desc: "Process petabytes of data efficiently. We leverage distributed computing frameworks like Apache Spark and Hadoop for massive scale."
              },
              {
                icon: Network,
                title: "Data Strategy & Governance",
                desc: "Ensure data quality, security, and compliance. We help you establish robust frameworks to manage your data assets securely."
              }
            ].map((service, idx) => (
      ...
      <section className="py-24 md:py-32 bg-white/[0.02] border-y border-white/5 relative">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-gray-400 max-w-2xl mx-auto">From raw data to actionable business intelligence.</p>
          </div>
          ...
          <div className="grid md:grid-cols-4 gap-8 relative">
            ...
            {[
              { step: "01", title: "Assessment", desc: "Auditing your current data siloes, quality, and business objectives.", icon: Search },
              { step: "02", title: "Architecture", desc: "Designing a scalable cloud data warehouse or lake infrastructure.", icon: Layers },
              { step: "03", title: "Integration", desc: "Building automated ETL pipelines to sync real-time data.", icon: Activity },
              { step: "04", title: "Visualization", desc: "Deploying interactive dashboards tailored to stakeholders.", icon: LineChart }
            ].map((item, idx) => (
        ...
        <div className="container mx-auto px-6 max-w-7xl flex flex-col md:flex-row gap-16 items-center">
          <div className="md:w-1/2">
            ...
            <p className="text-xl text-gray-400 mb-10 leading-relaxed">
              We treat data as a product. Our engineering standards ensure your data is accurate, secure, and delivered with sub-second latency.
            </p>
            <ul className="space-y-6">
              {[
                "Expertise in AWS, GCP, and Azure data ecosystems.",
                "Real-time streaming and batch processing.",
                "Strict compliance (GDPR, HIPAA, SOC2).",
                "Scalable designs that grow with your data volume."
              ].map((text, idx) => (
          ...
          <div className="md:w-1/2 grid grid-cols-2 gap-6 w-full">
            <div className="bg-white/[0.03] border border-white/10 p-8 rounded-3xl text-center flex flex-col justify-center transform translate-y-8">
              <span className="text-5xl font-black text-white mb-2">99.9%</span>
            ...
            <div className="bg-[#b1ff32]/10 border border-[#b1ff32]/20 p-8 rounded-3xl text-center flex flex-col justify-center">
              <span className="text-5xl font-black text-[#b1ff32] mb-2">PBs</span>
              <span className="text-gray-300 font-medium">of Data Processed</span>
            </div>
            <div className="bg-white/[0.03] border border-white/10 p-8 rounded-3xl text-center flex flex-col justify-center">
              <span className="text-5xl font-black text-white mb-2">Zero</span>
              <span className="text-gray-400 font-medium">Data Silos Left</span>
            </div>
            <div className="bg-white/[0.03] border border-white/10 p-8 rounded-3xl text-center flex flex-col justify-center transform -translate-y-8 mt-16 md:mt-0">
              <span className="text-5xl font-black text-white mb-2">&lt;1s</span>
              <span className="text-gray-400 font-medium">Query Latency</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 relative px-6">
        <div className="max-w-6xl mx-auto bg-[#b1ff32] rounded-[3rem] p-12 md:p-20 text-center relative overflow-hidden">
          ...
          <p className="mb-12 text-black/80 text-xl font-medium max-w-2xl mx-auto relative z-10 leading-relaxed">
            Stop making guesses. Start making data-driven decisions today with our enterprise analytics solutions.
          </p>
          <a
            href="/contact"
