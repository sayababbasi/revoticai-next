...
import { blogs } from "@/data/BlogDetail"; // Ensure this exports `blogs` array
...
//  Blog details page (type-safe and Next.js 15 compatible)
export default async function BlogDetailsPage({
  params,
}: {
  params: Promise<BlogPageParams>;
}) {
  const { slug } = await params; // unwrap Promise type from Next.js router
