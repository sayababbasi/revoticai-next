...
// --- Social Links Data ---
const socialLinks = [
  { name: "Instagram", href: "https://instagram.com/revoticai", icon: <InstagramIcon /> },
  { name: "X / Twitter", href: "https://x.com/revoticai", icon: <XIcon /> },
  { name: "LinkedIn", href: "https://linkedin.com/company/revoticai", icon: <LinkedInIcon /> },
  { name: "GitHub", href: "https://github.com/sayababbasi", icon: <GitHubIcon /> },
];
