...
// //               <a
// //                 href="https://youtube.com/revoticai"  target="_blank"
// //                 className="hover:text-white transition-colors"
// //                 aria-label="YouTube"
// //               >
// //                 <YoutubeIcon />
// //               </a>
// //               <a
// //                 href="https://linkedin.com/company/revoticai"  target="_blank"
// //                 className="hover:text-white transition-colors"
// //                 aria-label="LinkedIn"
// //               >
// //                 <LinkedinIcon />
// //               </a>
// //               <a
// //                 href="https://github.com/sayababbasi"  target="_blank"
// //                 className="hover:text-white transition-colors"
// //                 aria-label="GitHub"
// //               >
// //                 <GithubIcon />
// //               </a>
// //               <a
// //                 href="https://x.com/revoticai"  target="_blank"
// //                 className="hover:text-white transition-colors"
// //                 aria-label="X / Twitter"
// //               >
// //                 <XIcon />
// //               </a>
// //               <a
// //                 href="https://instagram.com/revoticai"  target="_blank"
// //                 className="hover:text-white transition-colors"
// //                 aria-label="Ins"
// //               >
// //                 <FacebookIcon />
...
//             <p className="mb-4 text-sm">
//               Subscribe our newsletter to join our journey to revolutionize the future of your Business with AI.
//             </p>
//             <form
...
//                 type="submit"
//                 disabled={loading}
//                 className="bg-neutral-700 text-white px-6 py-2 rounded-md font-semibold hover:bg-neutral-600 transition-colors flex-shrink-0 flex items-center justify-center"
//               >
//                 <SendIcon />
//               </button>
//             </form>
...
//             <div className="flex flex-wrap gap-4 mt-6">
//               <a href="https://youtube.com/revoticai" target="_blank" aria-label="YouTube" className="hover:text-white transition-colors">
//                 <YoutubeIcon />
//               </a>
//               <a href="https://linkedin.com/company/revoticai" target="_blank" aria-label="LinkedIn" className="hover:text-white transition-colors">
//                 <LinkedinIcon />
//               </a>
//               <a href="https://github.com/sayababbasi" target="_blank" aria-label="GitHub" className="hover:text-white transition-colors">
//                 <GithubIcon />
//               </a>
//               <a href="https://x.com/revoticai" target="_blank" aria-label="X / Twitter" className="hover:text-white transition-colors">
//                 <XIcon />
//               </a>
//               <a href="https://instagram.com/revoticai" target="_blank" aria-label="Facebook" className="hover:text-white transition-colors">
//                 <FacebookIcon />
//               </a>
//               <a href="https://instagram.com/revoticai" target="_blank" aria-label="Instagram" className="hover:text-white transition-colors">
//                 <InstagramIcon />
//               </a>
//             </div>
//           </div>
...
//           <p>
//             &copy; {new Date().getFullYear()} All rights reserved by{" "}
//             <span className="font-semibold text-white">Revotic AI</span> | Developed with Love
//           </p>
//         </div>
//       </motion.div>
//     </div>
...
const Footer: React.FC = () => {
  ...
  return (
    <div className="bg-black text-gray-400">
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-4 mt-6">
              <a href="https://youtube.com/revoticai" target="_blank" className="hover:text-white transition-colors" aria-label="YouTube">
                <YoutubeIcon />
              </a>
              <a href="https://linkedin.com/company/revoticai" target="_blank" className="hover:text-white transition-colors" aria-label="LinkedIn">
                <LinkedinIcon />
              </a>
              <a href="https://github.com/sayababbasi" target="_blank" className="hover:text-white transition-colors" aria-label="GitHub">
                <GithubIcon />
              </a>
              <a href="https://x.com/revoticai" target="_blank" className="hover:text-white transition-colors" aria-label="X / Twitter">
                <XIcon />
              </a>
              <a href="https://instagram.com/revoticai" target="_blank" className="hover:text-white transition-colors" aria-label="Facebook">
                <FacebookIcon />
              </a>
              <a href="https://instagram.com/revoticai" target="_blank" className="hover:text-white transition-colors" aria-label="Instagram">
                <InstagramIcon />
              </a>
            </div>
          </div>
      ...
      {/* Copyright */}
      <motion.div className="border-t border-neutral-800" initial="hidden" whileInView="visible" viewport={{ amount: 0.3 }} variants={fadeUp}>
        <div className="w-full max-w-[95%] mx-auto px-6 py-6 text-center text-sm">
          <p>
            &copy; {new Date().getFullYear()} All rights reserved by{" "}
