...
// // ============================================================
// // ✅ Inline SVG Icons (Safe for Next.js build)
// // ============================================================
// const SupportIcon = () => (
//   <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" stroke="currentColor"
//     strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
// // ============================================================
// // ✅ Helper function for countdown time
// // ============================================================
// const formatTime = (seconds: number) => {
...
//   const secs = seconds % 60;
//   const pad = (n: number) => n.toString().padStart(2, "0");
//   return hrs > 0 ? `${pad(hrs)}h ${pad(mins)}m ${pad(secs)}s` : `${pad(mins)}m ${pad(secs)}s`;
// };
...
// // ============================================================
// // ✅ Offer Modal Component (with countdown timer)
// // ============================================================
// const OfferModal: React.FC<{ onClose: () => void }> = ({ onClose }) => {
//   const [remainingTime, setRemainingTime] = useState(1800); // 30 minutes countdown
